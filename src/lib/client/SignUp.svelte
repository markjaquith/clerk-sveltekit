<script lang="ts">
	...
	let redirectUrlFromParam: string = $$props.redirectUrl || $$props.afterSignUpUrl || '/'
...
{#if showForm}
	<ClerkLoaded let:clerk>
		...
		<SignedOut>
			<div use:clerkUI={{ clerk, componentType: 'SignUp', props: {...$$props, redirectUrl: clerkRedirectUrl, afterSignUpUrl: null }}} />
		</SignedOut>
	</ClerkLoaded>
{/if}
